...
import {
  MatIconButton
} from "./chunk-TB3MOETG.js";
import {
  CdkScrollableModule,
  Overlay,
  TemplatePortal
} from "./chunk-QQXJOFNQ.js";
import {
  MAT_INPUT_VALUE_ACCESSOR
} from "./chunk-P7EOMUDQ.js";
import {
  NG_VALIDATORS,
  NG_VALUE_ACCESSOR,
  Validators
...
var MatTimepicker = class _MatTimepicker {
  ...
  open() {
    ...
    overlayRef.updateSize({
      width: this._input.getOverlayOrigin().nativeElement.offsetWidth
    });
  ...
  registerInput(input2) {
    if (this._input && input2 !== this._input && (typeof ngDevMode === "undefined" || ngDevMode)) {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function MatTimepickerToggle_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        ɵɵattribute("aria-label", ctx.ariaLabel())("aria-expanded", ctx.timepicker().isOpen())("tabindex", ctx.disabled() ? -1 : ctx.tabIndex());
      }
    },
